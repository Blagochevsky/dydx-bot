...
# KEYS - Production
# Must to be on the Mainnet DYDX
...
# KEYS - Development
# Must to be on the Testnet DYDX
...
HTTP_PROVIDER_GOERLI = config("HTTP_PROVIDER_GOERLI")
HTTP_PROVIDER = HTTP_PROVIDER_MAINNET if MODE == "PRODUCTION" else HTTP_PROVIDER_GOERLI
