...
def manage_trade_exits(client):
  ...
  for position in open_positions_dict:
    ...
    if not check_m1 or not check_m2 or not check_live:
      ...
      print(f"position_market_m1: {position_market_m1}, order_market_m1: {order_market_m1}")
      print(f"position_size_m1: {position_size_m1}, order_size_m1: {order_size_m1}")
      print(f"position_side_m1: {position_side_m1}, order_side_m1: {order_side_m1}")
      print(f"position_market_m2: {position_market_m2}, order_market_m2: {order_market_m2}")
      print(f"position_size_m2: {position_size_m2}, order_size_m2: {order_size_m2}")
      print(f"position_side_m2: {position_side_m2}, order_side_m2: {order_side_m2}")
      print(f"markets_live: {markets_live}")
      continue
    ...
    if is_close:
      ...
      try:
        ...
        print("\033[92mTrade is closed\033[0m")
